...
public class MySQLiteHelper extends SQLiteOpenHelper
{
	...
	private static final String FEED_TABLE_CREATE =
		    "CREATE TABLE " + FEED_TABLE + "("+
				    "  " + FEED_COL_ID + " text NOT NULL,"+
				    "  " + FEED_COL_NAME + " text NOT NULL,"+
				    "  " + FEED_COL_DESC + " text NOT NULL,"+
				    "  " + FEED_COL_WEBS + " text NOT NULL,"+
				    "  " + FEED_COL_URL + " text NOT NULL,"+
				    "  " + FEED_COL_UPDATE + " text NOT NULL,"+
				    "  " + FEED_COL_FOLD + " text NOT NULL"+
				    ");";
	...
	private static final String ARTI_TABLE_CREATE =
		    "CREATE TABLE " + ARTI_TABLE + "("+
				    "  " + ARTI_COL_ID + " text NOT NULL,"+
				    "  " + ARTI_COL_TITLE + " text NOT NULL,"+
				    "  " + ARTI_COL_AUTHOR + " text NOT NULL,"+
				    "  " + ARTI_COL_DATE + " text NOT NULL,"+
				    "  " + ARTI_COL_URL + " text NOT NULL,"+
				    "  " + ARTI_COL_CONTENT + " text NOT NULL,"+
				    "  " + ARTI_COL_ISFAV + " text NOT NULL,"+
				    "  " + ARTI_COL_ISREAD + " text NOT NULL,"+
				    "  " + ARTI_COL_IDFEED + " text NOT NULL"+
				    ");";
